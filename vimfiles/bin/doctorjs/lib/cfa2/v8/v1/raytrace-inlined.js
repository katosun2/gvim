...
var Class = { // Inlined the call to Class.create() in 31 call sites
  create: function() {
    return function() {
...
var PeriodicalExecuter = function() { this.initialize.apply(this, arguments); };
...
ObjectRange = function() { this.initialize.apply(this, arguments); };
...
Ajax.Request = function() { this.initialize.apply(this, arguments); };
Ajax.Request.Events =
...
Ajax.Updater = function() { this.initialize.apply(this, arguments); };
...
Ajax.PeriodicalUpdater = function() { this.initialize.apply(this, arguments); };
...
Insertion.Before = function() { this.initialize.apply(this, arguments); };
...
Insertion.Top = function() { this.initialize.apply(this, arguments); };
...
Insertion.Bottom = function() { this.initialize.apply(this, arguments); };
...
Insertion.After = function() { this.initialize.apply(this, arguments); };
...
Element.ClassNames = function() { this.initialize.apply(this, arguments); };
...
var Selector = function() { this.initialize.apply(this, arguments); };
Selector.prototype = {
...
Form.Element.Observer = function() { this.initialize.apply(this, arguments); };
...
Form.Observer = function() { this.initialize.apply(this, arguments); };
...
Form.Element.EventObserver = function() { this.initialize.apply(this, arguments); };
...
Form.EventObserver = function() { this.initialize.apply(this, arguments); };
...
Flog.RayTracer.Shape.BaseShape = function() { this.initialize.apply(this, arguments); };
